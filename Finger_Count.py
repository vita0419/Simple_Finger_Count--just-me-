...
while True:
    ...
    for i in prediction:
        ...
        if i[2] >= 0.8: #จากบรรทัดนี้ i[2] >= 0.8 หมายถึงค่าความเป็นไปได้ มากกว่าหรือเท่ากับ 80% ที่จะเป็นรูป 2 fingers
            text ="2 fingers"
            percent=i
        if i[3] >= 0.8: #จากบรรทัดนี้ i[3] >= 0.8 หมายถึงค่าความเป็นไปได้ มากกว่าหรือเท่ากับ 80% ที่จะเป็นรูป 3 fingers
            text ="3 fingers"
            percent=i
        if i[4] >= 0.8: #จากบรรทัดนี้ i[4] >= 0.8 หมายถึงค่าความเป็นไปได้ มากกว่าหรือเท่ากับ 80% ที่จะเป็นรูป 4 fingers
            text ="4 fingers"
            percent=i
        if i[5] >= 0.8: #จากบรรทัดนี้ i[5] >= 0.9 หมายถึงค่าความเป็นไปได้ มากกว่าหรือเท่ากับ 80% ที่จะเป็นรูป 5 fingers
            text ="5 fingers"
            percent=i
